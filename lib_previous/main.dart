...
import 'stateful_widget/stateful_widget_provider.dart';
import 'stateful_widget/stateful_widget_single_variable_stateprovider.dart';
import 'stateful_widget/stateful_widget_stateprovider.dart';
import 'stateless_widget/stateless_widget_provider.dart';
import 'stateless_widget/stateless_widget_provider_using_consumer.dart';
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const StatelessWidgetRiverpod())),
            ...
            ElevatedButton(
              onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const StatelessWidgetUsingConsumer())),
              child:
                  const Text('2. Stateless Widget using Consumer - Provider'),
            ),
            const SizedBox(
              height: 20,
            ),
            ...
            ElevatedButton(
              onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const StatefulWidgetRiverpod())),
            ...
            ElevatedButton(
              onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const StatefulWidgetStateProvider())),
            ...
            ElevatedButton(
              onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const StatefulWidgetSingleVariableStateProvider())),
              child: const Text(
                  '5. Stateless Widget Single Variable - StateProvider'),
            ),
            const SizedBox(
              height: 20,
            ),
